...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
            ...
            <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                ...
                <a href="../../demo1/dist/index.html">
                    <img alt="Logo" src="{{asset('public/assets/media/logos/cgb_logo.webp')}}" class="h-50px app-sidebar-logo-default" />
                    <img alt="Logo" src="{{asset('public/assets/media/logos/cgb_logo.webp')}}" class="h-30px app-sidebar-logo-minimize" />
                </a>
                <!--end::Logo image-->
                            ...
                            <a href="{{ url('admin/view-category')}}">
                                <span  class="menu-link"> 
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                        <svg fill="#8c93a6" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg" stroke="#8c93a6">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                            <g id="SVGRepo_iconCarrier"><defs><style>.cls-1{fill:none;}</style></defs>
                                            <title>category--new-each</title><path d="M29,10H24v2h5v6H22v2h3v2.142a4,4,0,1,0,2,0V20h2a2.0027,2.0027,0,0,0,2-2V12A2.0023,2.0023,0,0,0,29,10ZM28,26a2,2,0,1,1-2-2A2.0027,2.0027,0,0,1,28,26Z"></path>
                                            <path d="M19,6H14V8h5v6H12v2h3v6.142a4,4,0,1,0,2,0V16h2a2.0023,2.0023,0,0,0,2-2V8A2.0023,2.0023,0,0,0,19,6ZM18,26a2,2,0,1,1-2-2A2.0027,2.0027,0,0,1,18,26Z"></path>
                                            <path d="M9,2H3A2.002,2.002,0,0,0,1,4v6a2.002,2.002,0,0,0,2,2H5V22.142a4,4,0,1,0,2,0V12H9a2.002,2.002,0,0,0,2-2V4A2.002,2.002,0,0,0,9,2ZM8,26a2,2,0,1,1-2-2A2.0023,2.0023,0,0,1,8,26ZM3,10V4H9l.0015,6Z"></path>
                                            <rect id="_Transparent_Rectangle_" data-name="<Transparent Rectangle>" class="cls-1" width="0" height="0"></rect></g></svg>
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
