...
<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
	...
	<div class="app-navbar flex-shrink-0">
		...
		<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
			...
			<img src="{{ asset('storage/app/public/' . session('image')) }}" alt="user" /> 
			</div>
			...
			<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
				...
				<div class="menu-item px-3">
					<div class="menu-content d-flex align-items-center px-3">
						...
						<div class="symbol symbol-50px me-5">
							<img src="{{ asset('storage/app/public/' . session('image')) }}" alt="Logo" /> 
						</div>
						<!--end::Avatar-->
						<!--begin::Username-->
						@if($admin)
						<div class="d-flex flex-column">
							<div class="fw-bold d-flex align-items-center fs-5">{{ $admin->name }}
							<!-- <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span> -->
						</div>
							<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ $admin->email }}</a>
						</div>
						@endif
						<!--end::Username-->
					</div>
				...
				<div class="menu-item px-5 my-1">
					<a href="{{ route('admin.showpassword') }}" class="menu-link px-5">Change Password</a>
				</div>
				<!--end::Menu item-->
				<!--begin::Menu item-->
				<div class="menu-item px-5">
